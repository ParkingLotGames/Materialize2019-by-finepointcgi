...
#if !defined(INSTANCING_ON) && !defined(TOP_PROJECTION)
...
// -------- variant for: TOP_PROJECTION 
#if defined(TOP_PROJECTION) && !defined(INSTANCING_ON)
// Surface shader code generated based on:
// vertex modifier: 'vert'
// writes to per-pixel normal: YES
// writes to emission: YES
...
// -------- variant for: TOP_PROJECTION INSTANCING_ON 
#if defined(TOP_PROJECTION) && defined(INSTANCING_ON)
// Surface shader code generated based on:
// vertex modifier: 'vert'
// writes to per-pixel normal: YES
